...
CMD ["pytest","-m smoke or full_run", "--html=reports/report.html", "--self-contained-html", "--capture=no"]

# Uncomment the following line to run only smoke tests
# CMD ["pytest","-m smoke", "--html=reports/report.html", "--self-contained-html", "--capture=no"]
